...
export default function DetailModal({ open, onClose, task, templateOptions, successCount }: DetailModalProps) {
				...
				<Card>
					...
					<CardContent>
						<div className="space-y-2 mt-[-5px]">
							...
							<div className="flex gap-2">
								<label className="text-muted-foreground w-[80px]">成功数量：</label>
								<span>{successCount} 个号码</span>
							</div>
						</div>
					</CardContent>
				</Card>
						...
						{task.useTemplate === 1 && (
							<CardAction>
								<Button
									...
									size="sm"
								>
									<Icon icon="solar:eye-outline" size={15} />
									预览文案
								</Button>
							</CardAction>
						)}
