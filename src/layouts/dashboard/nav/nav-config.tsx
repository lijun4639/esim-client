...
export const navData: NavProps["data"] = [
	...
	{
		name: "sys.menu.message.index",
		items: [
			{
				title: "sys.menu.message.chat",
				path: "/message/chat",
				icon: <Icon icon="solar:dialog-2-outline" size="24" />,
			},
			{
				title: "sys.menu.message.bulkTask",
				path: "/message/bulk-tasks",
				icon: <Icon icon="solar:plain-2-outline" size="24" />,
			},
		],
	},
	{
		name: "sys.menu.template.index",
		items: [
			{
			...
			},
			{
				...
				icon: <Icon icon="solar:document-text-linear" size="24" />,
			},
		],
	},
	// {
